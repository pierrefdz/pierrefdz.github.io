...
This is helpful for content sharing platforms, to know if an image was generated by the model for instance.
...
This is done while keeping a FPR at $$10^{-6}$$ (only 1 vanilla image out of $$10^6$$ is flagged), and with a false accusation rate of zero, meaning that we never identify the wrong user.
